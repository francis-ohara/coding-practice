...
# Tests
print(
    f"There are {word_counter(money)} words and {char_counter(money)} non-whitespace characters in money.txt"
)
print(
    f"There are {word_counter(sign)} words and {char_counter(sign)} non-whitespace characters in sign.txt"
)
