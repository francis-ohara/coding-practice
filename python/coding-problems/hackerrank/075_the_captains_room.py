...
# A Captain.
# -4 An unknown group of families consisting of K members per group where K 1.
...
# of the tourists. The room numbers will appear K times per group except for the Captain's room.
